document.addEventListener('DOMContentLoaded', function() {
    ...
    marker.bindPopup("<b>LOMBA VALLE</b><br>Location details here.").openPopup();
});

document.addEventListener('DOMContentLoaded', function() {
    const slider = document.getElementById('targetSlider');
    const manualInput = document.querySelector('.custom-manual-input');

    slider.addEventListener('input', function() {
        const value = parseInt(this.value);
        manualInput.value = new Intl.NumberFormat('id-ID', {
            style: 'currency',
            currency: 'IDR',
